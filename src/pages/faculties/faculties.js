...
export default function Faculties() {
    ...
    const facultyMembers = [
        { id: 1, name: "John Doe", position: "Professor", image: "john-doe.jpg" },
        { id: 2, name: "John Doe", position: "Professor", image: "john-doe.jpg" },
        { id: 3, name: "John Doe", position: "Professor", image: "john-doe.jpg" },
        { id: 4, name: "John Doe", position: "Professor", image: "john-doe.jpg" },
    ];
        ...
        <div className="faculties">
            ...
            <div className="faculty-mem">
                {facultyMembers.map(member => (
                    <div key={member.id} className={member.id % 2 === 0 ? "container-b" : "container-y"}>
